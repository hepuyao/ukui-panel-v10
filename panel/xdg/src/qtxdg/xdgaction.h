...
class QTXDG_API XdgAction : public QAction
{
    Q_OBJECT
public:
    explicit XdgAction(QObject *parent=NULL);
    explicit XdgAction(const XdgDesktopFile& desktopFile, QObject *parent=NULL);
    explicit XdgAction(const XdgDesktopFile* desktopFile, QObject *parent=NULL);
    explicit XdgAction(const QString& desktopFileName, QObject *parent=NULL);
    // Constructs a XdgAction that is a copy of the given XdgAction.
    explicit XdgAction(const XdgAction& other, QObject *parent=NULL);
