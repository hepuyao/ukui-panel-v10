...
public:
    ...
    XdgMenuWidget(const XdgMenu& xdgMenu, const QString& title = QString(), QWidget* parent=NULL);

    /// Constructs a menu for menuElement with parent.
    explicit XdgMenuWidget(const QDomElement& menuElement, QWidget* parent=NULL);

    /// Constructs a copy of other.
    XdgMenuWidget(const XdgMenuWidget& other, QWidget* parent=NULL);
